row12:	.half 0x000B, 0x010B, 0x020B, 0x030B, 0x040B, 0x050B, 0x060B, 0x070B, 0x080B, 0x090B, 0x0A0B, 0x0B0B, 0x0C0B, 0x0D0B, 0x0E0B, 0x0F0B, 0x100B, 0x110B, 0x120B, 0x130B
row13:	.half 0x000C, 0x010C, 0x020C, 0x030C, 0x040C, 0x050C, 0x060C, 0x070C, 0x080C, 0x090C, 0x0A0C, 0x0B0C, 0x0C0C, 0x0D0C, 0x0E0C, 0x0F0C, 0x100C, 0x110C, 0x120C, 0x130C
row14:	.half 0x000D, 0x010D, 0x020D, 0x030D, 0x040D, 0x050D, 0x060D, 0x070D, 0x080D, 0x090D, 0x0A0D, 0x0B0D, 0x0C0D, 0x0D0D, 0x0E0D, 0x0F0D, 0x100D, 0x110D, 0x120D, 0x130D
row15:	.half 0x000E, 0x010E, 0x020E, 0x030E, 0x040E, 0x050E, 0x060E, 0x070E, 0x080E, 0x090E, 0x0A0E, 0x0B0E, 0x0C0E, 0x0D0E, 0x0E0E, 0x0F0E, 0x100E, 0x110E, 0x120E, 0x130E
row16:	.half 0x000F, 0x010F, 0x020F, 0x030F, 0x040F, 0x050F, 0x060F, 0x070F, 0x080F, 0x090F, 0x0A0F, 0x0B0F, 0x0C0F, 0x0D0F, 0x0E0F, 0x0F0F, 0x100F, 0x110F, 0x120F, 0x130F
row17:	.half 0x0010, 0x0110, 0x0210, 0x0310, 0x0410, 0x0510, 0x0610, 0x0710, 0x0810, 0x0910, 0x0A10, 0x0B10, 0x0C10, 0x0D10, 0x0E10, 0x0F10, 0x1010, 0x1110, 0x1210, 0x1310
row18:	.half 0x0011, 0x0111, 0x0211, 0x0311, 0x0411, 0x0511, 0x0611, 0x0711, 0x0811, 0x0911, 0x0A11, 0x0B11, 0x0C11, 0x0D11, 0x0E11, 0x0F11, 0x1011, 0x1111, 0x1211, 0x1311
row19:	.half 0x0012, 0x0112, 0x0212, 0x0312, 0x0412, 0x0512, 0x0612, 0x0712, 0x0812, 0x0912, 0x0A12, 0x0B12, 0x0C12, 0x0D12, 0x0E12, 0x0F12, 0x1012, 0x1112, 0x1212, 0x1312
row20:	.half 0x0013, 0x0113, 0x0213, 0x0313, 0x0413, 0x0513, 0x0613, 0x0713, 0x0813, 0x0913, 0x0A13, 0x0B13, 0x0C13, 0x0D13, 0x0E13, 0x0F13, 0x1013, 0x1113, 0x1213, 0x1313
...
checker:
	...
	LDRB r2, [r2]
leftWall:
	CMP r0, #0x00		;check if x is 0
	BNE	rightWall
	CMP r2, #3			;check if direction is left
	BNE	rightWall
	B end_game			;if yes on both then wall is hit
rightWall:
	CMP r0, #0x13		;check if x is 19
	BNE topWall
	CMP r2, #1			;check if direction is right
	BNE topWall
	B end_game			;if yes on both then wall is hit
topWall:
	CMP r1, #0x00		;check if y is 0
	BNE bottomWall
	CMP r2, #0			;check if direction is up
	BNE bottomWall
	B end_game			;if yes on both then wall is hit
bottomWall:
	CMP r1, #0x13		;check if y is 19
	BNE checker_end
	CMP r2, #2			;check if direction is down
	BNE checker_end
	B end_game			;if yes on both then wall is hit
checker_end:
...
mover:
	...
	LDRB r2, [r2]
Up:
	CMP r2, #0		;if drection is up then sub 1 from y
	BNE Right
	SUB r1, #1
	B mover_end
Right:
	CMP r2, #1		;if direction is right then add 1 to x
	BNE Down
	ADD r0, #1
	B mover_end
Down:
	CMP r2, #2		;if direction is down then add 1 to y
	BNE Left
	ADD r1, #1
	B mover_end
Left:
	CMP r2, #3		;if direction is left then sub 1 from x
	BNE mover_end
	SUB r0, #1
	B mover_end
mover_end:
	LDR r2, ptr_to_cordinatesNext
	BL encode		;store these new cordinates in memory for corindatesNext
...
printer:
	...
	BL new_line
	LDR r1, ptr_to_row1		;print row 1
	BL printer_assist
	LDR r1, ptr_to_row2		;print row 2
	BL printer_assist
	LDR r1, ptr_to_row3		;print row 3
	BL printer_assist
	LDR r1, ptr_to_row4		;print row 4
	BL printer_assist
	LDR r1, ptr_to_row5		;print row 5
	BL printer_assist
	LDR r1, ptr_to_row6		;print row 6
	BL printer_assist
	LDR r1, ptr_to_row7		;print row 7
	BL printer_assist
	LDR r1, ptr_to_row8		;print row 8
	BL printer_assist
	LDR r1, ptr_to_row9		;print row 9
	BL printer_assist
	LDR r1, ptr_to_row10	;print row 10
	BL printer_assist
	LDR r1, ptr_to_row11	;print row 11
	BL printer_assist
	LDR r1, ptr_to_row12	;print row 12
	BL printer_assist
	LDR r1, ptr_to_row13	;print row 13
	BL printer_assist
	LDR r1, ptr_to_row14	;print row 14
	BL printer_assist
	LDR r1, ptr_to_row15	;print row 15
	BL printer_assist
	LDR r1, ptr_to_row16	;print row 16
	BL printer_assist
	LDR r1, ptr_to_row17	;print row 17
	BL printer_assist
	LDR r1, ptr_to_row18	;print row 18
	BL printer_assist
	LDR r1, ptr_to_row19	;print row 19
	BL printer_assist
	LDR r1, ptr_to_row20	;print row 20
	BL printer_assist
	LDR r0, ptr_to_topNbottom
...
printer_assist_looper:
	CMP r4, #20				;only print 20 space on the gameboard
	ADD r4, #1
	BEQ printer_assist_end
	LDRH r3, [r1]			;store cordinates
	ADD r1, #2				;next block in row
	CMP r3,	r2				;see if current x/y are the loaction of *
	BNE print_space
	MOV r0, #0x2A			;print * if yes
	PUSH {r1, r2}
	BL output_character
	POP {r1, r2}
	B printer_assist_looper
print_space:
	MOV r0, #0x20			;print space if not * postion
	PUSH {r1, r2}
	BL output_character
	POP {r1, r2}
	B printer_assist_looper
